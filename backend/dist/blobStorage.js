...
exports.issueClientUploadToken = issueClientUploadToken;
...
async function issueClientUploadToken(pathname, opts) {
    return (0, client_1.generateClientTokenFromReadWriteToken)({
        pathname,
        addRandomSuffix: true,
